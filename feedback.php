...
<title>Acamar Web || Feedback </title>
...
<a href="index.php" class="pull-right btn sub1 title3"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Inicío</a>&nbsp;
</div></div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="email" name="text" placeholder="Matricula" class="form-control input-md" type="email">
...
<h2 align="center" style="font-family:'typo'; color:#000066">Feedback/Reportar Problema</h2>
<div style="font-size:14px">
<?php if(@$_GET['q'])echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;'.@$_GET['q'].'</span>';
else
{echo' 
Você pode reportar diretamente pelo email abaixo:<br />
<div class="row">
<div class="col-md-1"></div>
<div class="col-md-10">
<a href="mailto:joses.magalhaes@hotmail.com" style="color:#000000">joses.magalhaes@hotmail.com</a><br /><br />
</div><div class="col-md-1"></div></div>
<p>ou através do formulário abaixo: </p>
...
<div class="form-group"> 
<textarea rows="5" cols="8" name="feedback" class="form-control" placeholder="Escreva sua mensagem aqui..."></textarea>
</div>
